...
public class MinPasswordLimitRegistration extends BrowserConfiguration {
	...
	@Test
	public void limitCheck() throws IOException, InterruptedException {
		...
		password.sendKeys(PropertyReader.getProperties("passwordsMin"));
		logger.log(LogStatus.INFO, "Entering password");

		// entering confirm password
		WebElement confirmPassword = driver.findElement(By.id("input-confirm"));
		confirmPassword.sendKeys(PropertyReader.getProperties("confirmPasswordmin"));
		...
		WebElement passwordWarning = driver.findElement(By.className("text-danger"));
		status = passwordWarning.isDisplayed();

		logger.log(LogStatus.WARNING, passwordWarning.getText() + " is displayed");
	...
	public void afterMethod() {
		if (status) {
			...
			logger.log(LogStatus.PASS, "Test Pass , Warning Displayed");
		} else
			logger.log(LogStatus.FAIL, "Test Failed, Warning not displayed");
